...
public class KitchenCabinetInterfaceMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public KitchenCabinetInterfaceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        ...
        // Cabinet slots
        if (this.blockEntity instanceof OakKitchenCabinetBlockEntity || this.blockEntity instanceof SpruceKitchenCabinetBlockEntity || this.blockEntity instanceof BirchKitchenCabinetBlockEntity) {
            int slotSize = 18;
            int startX = 8;
            int startY = 17;

...
public class AcaciaKitchenCabinetBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AcaciaKitchenCabinetBlockEntity(BlockPos position, BlockState state) {
		super(ConcoctionModBlockEntities.ACACIA_KITCHEN_CABINET.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("acacia_kitchen_cabinet");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new KitchenCabinetInterfaceMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Acacia Kitchen Cabinet");
	}

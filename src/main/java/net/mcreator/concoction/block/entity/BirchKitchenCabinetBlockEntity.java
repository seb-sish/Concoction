...
public class BirchKitchenCabinetBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public BirchKitchenCabinetBlockEntity(BlockPos position, BlockState state) {
		super(ConcoctionModBlockEntities.BIRCH_KITCHEN_CABINET.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("birch_kitchen_cabinet");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Birch Kitchen Cabinet");
	}

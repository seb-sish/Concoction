...
public class SpruceKitchenCabinetBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public SpruceKitchenCabinetBlockEntity(BlockPos position, BlockState state) {
		super(ConcoctionModBlockEntities.SPRUCE_KITCHEN_CABINET.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("spruce_kitchen_cabinet");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Spruce Kitchen Cabinet");
	}
